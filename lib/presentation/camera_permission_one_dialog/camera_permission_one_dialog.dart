import 'controller/camera_permission_one_controller.dart';import 'package:flutter/material.dart';import 'package:loan_link/core/app_export.dart';
// ignore_for_file: must_be_immutable
class CameraPermissionOneDialog extends StatelessWidget {CameraPermissionOneDialog(this.controller, {Key? key}) : super(key: key);

CameraPermissionOneController controller;
...
onTapTxtAction() { Get.toNamed(AppRoutes.securityOneScreen, ); } 
/// Navigates to the selfieCaptureInstructionOneScreen when the action is triggered.
onTapTxtAction1() { Get.toNamed(AppRoutes.selfieCaptureInstructionOneScreen, ); } 
 }
